...
# file2 = f"{CWD}/RVE_input.csv"
file2 = f"{CWD}/RVE_input_ellipsoid_filtered.csv"
#DP800
...
submodel_flag = False
damask_flag = True
phase2iso_flag = False
x_fem_flag = False
element_type = 'HEX8'
anim_flag = False

files = {1: None, 2: file2, 3: None, 4: None, 5: None, 6: None}  # , 2: file2, 6: file6}
phase_ratio = {1: 0, 2: 1.0, 3: 0, 4: 0, 5: 0, 6: 0}
phases = ['Martensite'] #, 'Bands']
